...
function create_each_block_3(ctx) {
	...
	return {
		...
		h() {
			...
			attr(a, "class", "link svelte-vxxv0k");
		},
		m(target, anchor) {
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			attr(a, "href", "/");
			attr(a, "class", "logo svelte-vxxv0k");
			attr(hr, "class", "svelte-vxxv0k");
			...
			attr(svg, "class", "svelte-vxxv0k");
			attr(button, "id", "close");
			attr(button, "aria-label", "Close Navigation");
			attr(button, "class", "svelte-vxxv0k");
			attr(nav_1, "id", "mobile-nav");
			attr(nav_1, "class", "svelte-vxxv0k");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			...
			attr(button, "class", "svelte-vxxv0k");
			attr(div0, "class", "call-to-action svelte-vxxv0k");
			attr(div1, "class", "section-container svelte-vxxv0k");
			attr(header, "class", "svelte-vxxv0k");
		},
		m(target, anchor) {
