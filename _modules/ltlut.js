...
function create_each_block(ctx) {
	...
	return {
		...
		h() {
			attr(a, "href", a_href_value = /*link*/ ctx[2].url);
			attr(a, "aria-label", a_aria_label_value = /*icon*/ ctx[3]);
			attr(a, "class", "svelte-1pqt5op");
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			...
			if (!current || dirty & /*social*/ 2 && a_aria_label_value !== (a_aria_label_value = /*icon*/ ctx[3])) {
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			attr(nav_1, "class", "svelte-1pqt5op");
			attr(a, "href", "https://primo.so");
			attr(a, "class", "svelte-1pqt5op");
			attr(span, "class", "primo svelte-1pqt5op");
			attr(ul, "class", "svelte-1pqt5op");
			attr(div, "class", "section-container svelte-1pqt5op");
			attr(footer, "class", "svelte-1pqt5op");
		},
		m(target, anchor) {
...
class Component$1 extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$1, create_fragment$1, safe_not_equal, { nav: 0, social: 1 });
	}
}
